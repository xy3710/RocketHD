...
bool rtp_eof_helper::h264_end_block(const uint8_t *payload,
...
bool rtp_eof_helper::h265_end_block(const uint8_t *payload,
                                       const std::size_t payloadSize) {
...
bool rtp_eof_helper::mjpeg_end_block(const uint8_t *payload,
                                        const std::size_t payloadSize) {
